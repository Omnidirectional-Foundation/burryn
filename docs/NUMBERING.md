...
> 相关文档：[`architecture.md`](architecture.md) 实现权威 · [`GOALS.md`](GOALS.md) 阶段表 · [`../README.md`](../README.md)
...
| §6.7 Effects / Refinement / GADTs / Linear | 重型类型系统其余项 | 明确排除（见 [`GOALS.md`](GOALS.md) §7.2） |
